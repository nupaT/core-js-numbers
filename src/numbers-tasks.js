...
/* if we can't to summ the bigInt numbers, then we divide. We can solve this problem by to summ up half of these numbers
 */
...
function getCountOfOddNumbers(number) {
  ...
  for (let a = 0; a <= Math.abs(number); a += 1) {
    if (a % 2) {
      count += 1;
    }
  }
